...
from .views import (
    PollListCreateView,
    PollDetailView,
    CastVoteView,    # <-- Use this instead of VoteAPIView
    PollResultsView  # <-- Use this instead of PollResultsAPIView
)
...
urlpatterns = [
    ...
    # path('votes/my-votes/', UserVotesView.as_view(), name='user-votes'),  # Uncomment if you have this view
